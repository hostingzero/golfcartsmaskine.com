  ...
  <div class="blogger">
    ...
    if(get_theme_mod('sayara_automotive_blog_description', 'Post Excerpt') == 'Post Excerpt'){ ?>
      <?php if(get_the_excerpt()) { ?>
        <div class="text"><p><?php $excerpt = get_the_excerpt(); echo esc_html( sayara_automotive_string_limit_words( $excerpt, esc_attr(get_theme_mod('sayara_automotive_excerpt_number','20')))); ?> <?php echo esc_html( get_theme_mod('sayara_automotive_post_excerpt_suffix','{...}') ); ?></p></div>
      <?php } ?>
    <?php }?>
