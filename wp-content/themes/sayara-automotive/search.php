...
<main id="main" role="main">
	<div class="container">
		<header role="banner" class="page-header">
			...
			<?php else : ?>
				<h1 class="page-title"><?php echo esc_html(get_theme_mod('sayara_automotive_no_search_result_title',__('Nothing Found','sayara-automotive')));?></h1>
			<?php endif; ?>
		</header>
		<div class="row">
			<?php
				...
				<div class="col-lg-8 col-md-8">
					<?php
						if ( have_posts() ) :
							...
							<p><?php echo esc_html(get_theme_mod('sayara_automotive_no_search_result_content',__('Sorry, but nothing matched your search terms. Please try again with some different keywords.','sayara-automotive')));?></p>
							<?php
								get_search_form();
